...
const CreateTimer = () => {
  ...
  const handleNumberOfIntervalsChange = (
  ...
  const handleNumberOfExercisesChange = (
    e: React.ChangeEvent<HTMLInputElement>
  ): void => {
    const number: number = parseInt(e.target.value);
  ...
  const handleLenghtOfExerciseChange = (
    e: React.ChangeEvent<HTMLInputElement>
  ): void => {
  ...
  const handleLengthOfRestExerciseChange = (
    e: React.ChangeEvent<HTMLInputElement>
  ): void => {
    const length = parseInt(e.target.value);
  ...
  const handleLengthOfRestIntervalChange = (
    e: React.ChangeEvent<HTMLInputElement>
  ): void => {
    const length = parseInt(e.target.value);
  ...
  return (
    <div className={styles.timerCreator}>
      ...
      <label htmlFor="numberOfExercises">
        Number of exercises in one interval
      </label>
      <div>
        <input
          type="range"
      ...
      <br />
      <label htmlFor="lengthOfRestExercise">
        Length of rest after exercise
      </label>
      <div>
        <input
          type="number"
      ...
      <br />
      <label htmlFor="lengthOfRestInterval">
        Length of rest after interval
      </label>
      <div>
        <input
          type="number"
      ...
      <br />
      <button className={styles.addTrainingButton} onClick={handleAddTraining}>
        Add training
      </button>
      <br />
    </div>
