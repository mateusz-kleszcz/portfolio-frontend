...
const DurationBar = (): ReactElement => {
    ...
    const { selectedSongCurrentTime, selectedSongDuration } = useSelector((state: AppState) => state.playerReducer)
    ...
    useEffect(() => {
        const durationWidth = selectedSongCurrentTime / selectedSongDuration * 100
